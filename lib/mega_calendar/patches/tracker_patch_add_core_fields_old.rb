    ...
    module TrackerPatch
      def self.included(base) # :nodoc
        ...
        base.class_eval do
          ...
          def add_default_core_fields_with_plugin

            unless (self.class.const_defined?(:EXTRA_CORE_FIELDS))
              redef_const_without_warning
            end

            add_default_core_fields_without_plugin
          end

          alias_method_chain :add_default_core_fields, :plugin
